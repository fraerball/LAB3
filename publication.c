...
int cmp_year_asc(const void* value1, const void* value2){
    ...
    const publication_t* publication_value1 = (const publication_t*)value1;
    const publication_t* publication_value2 = (const publication_t*)value2;
    
    if (publication_value1->publication_year != publication_value2->publication_year){
        return publication_value1->publication_year - publication_value2->publication_year;
    }

    return publication_value1->citation_quantity - publication_value2->citation_quantity;
...
int cmp_cit_asc(const void* value1, const void* value2){
    ...
    if (publication_value1->citation_quantity != publication_value2->citation_quantity){
        return publication_value1->citation_quantity - publication_value2->citation_quantity;
    }
